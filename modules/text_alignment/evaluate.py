...
def main(micro_averaged, plag_path, plag_tag_name, det_path, det_tag_name):
    ...
    print( 'Plagdet Score', plag_score )
    print( 'Recall', rec )
    print( 'Precision', prec )
    print( 'Granularity', gran )
    return (plag_score, rec, prec, gran)

def evaluate(outdir, true_value_dir):
    #   default=True
    micro_average = True
    plag_path = true_value_dir
    #   Default='plagiarism'
    plag_tag_name = 'plagiarism'
    det_path = outdir
    #   Default='detected-plagiarism'
    det_tag_name = 'detected-plagiarism'
    main(micro_average, plag_path, plag_tag_name, det_path, det_tag_name)
