...
# WHEN
MENTION_TIMES = [
    'TIME_DATE', 'TIME_OF_THE_DAY', 'TIME_DURATION', 'TIME_REPETITION'
]
# WHERE
MENTION_LOCATIONS = [
    'LOC_GEO', 'LOC_FAC', 'LOC_OTHER',
]
# WHO-HUMAN
MENTION_HUMANS = [
    'HUMAN_PART_PER', 'HUMAN_PART_ORG', 'HUMAN_PART_GPE', 'HUMAN_PART_FAC', 'HUMAN_PART_VEH', 'HUMAN_PART_MET', 'HUMAN_PART_GENERIC'
]
# WHO-NON HUMAN
MENTION_NON_HUMANS = [
