...
if __name__ == "__main__":
    ...
    parser.add_argument('--num-topics', type=int, nargs='?', const=100,
                        help='Number of desired topics')

    # Optional positional argument
    parser.add_argument('--chunk-size', type=int, nargs='?', const=10000,
                        help='Number of documents in a chunk')

    # Optional argument
    parser.add_argument('--passes', type=int, nargs='?', const=0,
                        help='Number of times to pass through whole corpus')

    # Optional argument
    parser.add_argument('--out-dir', type=str, nargs='?', const=f'{DATA_FOLDER}',
                        help='Number of times to pass through whole corpus')

    # Optional argument
    parser.add_argument('--data-dir', type=str, nargs='?', const=f'{OUTPUT_FOLDER}',
                        help='Number of times to pass through whole corpus')
    ...
    start(num_topics, chunk_size, passes, args.data_dir, args.out_dir)